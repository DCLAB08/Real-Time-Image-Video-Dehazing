...
# source ../verilog-ethernet/syn/quartus/eth_mac_1g_rgmii.sdc
# source ../verilog-ethernet/syn/quartus/rgmii_phy_if.sdc
# source ../verilog-ethernet/syn/quartus/rgmii_io.sdc
# source ../verilog-ethernet/lib/axis/syn/quartus/sync_reset.sdc
# source ../verilog-ethernet/lib/axis/syn/quartus/axis_async_fifo.sdc

# Remember to modify the source (Note that the root file is located at the place you create the project in QUARTUS)
source verilog-ethernet/syn/quartus/eth_mac_1g_rgmii.sdc
source verilog-ethernet/syn/quartus/rgmii_phy_if.sdc
source verilog-ethernet/syn/quartus/rgmii_io.sdc
source verilog-ethernet/lib/axis/syn/quartus/sync_reset.sdc
